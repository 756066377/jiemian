...
一个基于 Tauri + React + TypeScript 开发的国产钢材型号查询系统，提供全面的型钢数据查询、过滤、详细规格展示、钢板展开计算和钢铁牌号国际标准对照查询功能。
...
- **钢铁牌号查询**：支持 DIN/GB/JIS/AISI 国际标准牌号对照查询（103 条数据）
...
- ✨ 新增钢铁牌号国际标准对照查询
  - 支持 DIN/GB/JIS/AISI 四大国际标准对照
  - 收录 103 条钢铁牌号数据
  - 涵盖不锈钢、铸钢、碳素结构钢等 5 大类别
  - 智能搜索支持任意标准牌号查询
- 🎨 优化开发者信息卡片
  - 黑金银行卡风格 UI 设计
  - 移除关闭按钮，点击空白处关闭
- 🔧 修正 K-Factor 法钣金展开计算公式
  - 直边长度计算修正为 `外尺寸 - (R + T)`
- 📊 新增折弯线距离显示
  - 公式：`折弯线距离 = 直边长度 + BA/2`
